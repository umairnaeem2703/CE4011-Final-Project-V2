...
| 5D4C Modal mode-shape plotting           | DONE   | Dynamic Results now uses modal summary, mode-shape, and matrix tabs with modal-only matrix resolution and clear missing-data handling. |
